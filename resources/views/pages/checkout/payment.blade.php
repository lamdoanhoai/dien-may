    ...
    <section id="cart_items">
            <div class="container">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="cart_product">
                                <a href=""><img src="{{URL::to('public/uploads/product/'.$v_content->options->images)}}" width="50" alt=""></a>
                            </td>
                ...
                <div class="payment-options">
                        ...
                        <span>
                            <label><input name="payment_option" value="3" type="checkbox"> metamask</label>
                        </span>
