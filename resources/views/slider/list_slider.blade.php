      ...
      <table class="table table-striped b-t b-light">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><img src="public/uploads/slider/{{$slide->slider_image}}"height="120"width="350" ></td>
            ...
            <td>
                <a onclick="return confirm('bạn có muốn xóa?')" href="{{URL::to('/delete-slider/'.$slide->slider_id)}}" class="active styling-edit" ui-toggle-class="">
