...
class GalleryController extends Controller
{
 public function AuthLogin(){
    ...
    public function add_gallery($product_id){
        ...
        $pro_id = $product_id;
        return view('gallery.add_gallery')->with(compact('pro_id'))->with('slider',$slider);
            ...
            foreach($gallery as $key => $gal){
                ...
                $output.='
                     ...
                     <tr>
                                        ...
                                        <img src="'.url('public/uploads/gallery/'.$gal->gallery_images).'" class="img-thumbnail" width="120" height="120">
