...
class BrandProduct extends Controller
{
   ...
   public function add_brand_product(){
    ...
    public function active_brand_product($brand_product_id){
        ...
        Session::put('message',' hiện thương hiệu phẩm thành công');
        return Redirect::to('all-brand-product');
    ...
    public function update_brand_product(Request $request,$brand_product_id){
     ...
     public function delete_brand_product($brand_product_id){
        ...
        $brand_by_id = DB::table('tbl_product')->join('tbl_brand','tbl_product.brand_id','=','tbl_brand.brand_id')->where('tbl_product.brand_id',$brand_id)->where('product_status',0)->orderby('product_id','desc')->get();
